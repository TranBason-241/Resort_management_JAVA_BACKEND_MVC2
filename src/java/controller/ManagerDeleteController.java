 ...
 * @author ADMIN
 */
@WebServlet(name = "ManagerDeleteController", urlPatterns = {"/ManagerDeleteController"})
public class ManagerDeleteController extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(ManagerDeleteController.class);
